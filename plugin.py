...
class BasePlugin:
    ...
    def onStart(self):
        ...
        #    self.pumppower = 1
        self.pumppower = Parameters["Mode2"]
                ...
                if self.SPTempCheck >= 31:
                    ...
                    if self.SPTempCheck <= 15:
                        ...
                        if self.SPTempCheck <= 24:
                            self.PumpTemp = round(((self.SPTempCheck / 3), 1) * float(self.pumppower))
                            ...
                            self.PumpTemp = round(((self.SPTempCheck / 2), 1) * float(self.pumppower))
                            self.FiltrationVarNextRefresh = now + timedelta(hours=4)
