...
# Heartbeat  ---------------------------------------------------
    ...
    def onHeartbeat(self):
        ...
        if Devices[1].sValue == "0": # Off
            ...
            Devices[11].Update(nValue=0, sValue="Auto - Calcul. {}H - {}:{} / {}:{}".format(self.PumpTempRounded,self.startpump.hour, self.startpump.minute, self.stoppump.hour, self.stoppump.minute)
