...
# Read Analyzer---------------------------------------------------------------------------------------------
    def readAnalyzer(self):
        ...
        self.nextAnalyzer = datetime.now()
        # PH
        jsonData = DomoticzAPI("type=command&param=getdevices&rid={}".format(self.PHValidx))
        if jsonData:
        ...
        # Redox
        jsonData = DomoticzAPI("type=command&param=getdevices&rid={}".format(self.RedoxValidx))
        if jsonData:
