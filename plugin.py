...
def DomoticzAPI(APICall):
    ...
    try:
        ...
        Domoticz.Error("HTTP error calling '{}': {}".format(url, e))

    except urllib.error.URLError as e:
        Domoticz.Error("URL error calling '{}': {}".format(url, e))

    except socket.timeout:
        Domoticz.Error("Timeout (10s) calling '{}'".format(url))

    except json.JSONDecodeError as e:
        Domoticz.Error("JSON decoding error: {}".format(e))
