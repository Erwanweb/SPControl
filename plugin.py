        ...
        if jsonData1:
            for device in jsonData1["result"]:
                if "Data" in device:
                    ...
                    Devices[7].Update(nValue=2, sValue="Parfait") # update the dummy device 0-gris 1-vert 2-yellow 3-orange 4-red
        # Redox
        ...
        if jsonData2:
            for device in jsonData2["result"]:
                if "Data" in device:
                    ...
                    elif self.RedoxVal => 600 and self.RedoxVal =< 649 :
                        Devices[9].Update(nValue=3,sValue="Legerement bas")
                    elif self.RedoxVal =< 599 :
